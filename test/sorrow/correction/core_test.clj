(ns sorrow.correction.core-test
  (:require [clojure.test :refer :all]
            [sorrow.correction.core :refer :all]))
...
(deftest test-checksum-calculator
  (testing "Calculation of checksums"
    (let [ws {:p 37 :w [4 16 27 34 25 26 30 9] :w' [35 4 29 16 5 27 20 34]}
          calc (#'sorrow.correction.core/checksum-calculator ws)]
...
(deftest test-classify-checksums
  (testing "Classification of checksum pairs"
    (is (= :correct (#'sorrow.correction.core/classify-checksums 0 0)))
    (is (= :uncorrectable (#'sorrow.correction.core/classify-checksums 5 0)))
    (is (= :correctable (#'sorrow.correction.core/classify-checksums 7 6)))))
